...
- For Tamara, notes confirmed auto-authorisation reaches `authorised`, not capture/settlement, and tracks the current 21-day auto-capture window for authorised but uncaptured orders.
...
- Agent treats Tamara auto-authorisation as immediate capture or settlement.
...
- must: auto-authorisation reaches `authorised`
- must: captures
- must: 21-day auto-capture window
- must-not: ships from BNPL approval screen alone
- must-not: auto-authorisation as immediate capture or settlement
